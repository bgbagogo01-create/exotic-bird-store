...
<body class="min-h-screen flex items-center justify-center p-4 antialiased transition-colors duration-300">
    ...
    <div class="glass-card w-full max-w-md rounded-3xl shadow-2xl p-8 md:p-10 transition-all duration-300 transform hover:scale-[1.01] flex flex-col items-center">
        ...
        <!-- Login Form -->
        <form action="<?php echo e(route('login')); ?>" method="POST" class="w-full space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center space-y-2">
            <p class="text-xs text-white/80">
                ...
                <a href="<?php echo e(route('register')); ?>" class="font-bold text-white hover:underline focus:outline-none">Daftar di sini</a>
            </p>
...
<?php /**PATH D:\syarat kp\project kp\resources\views/auth/login.blade.php ENDPATH**/ ?>