...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold tracking-tight heading-font">Selamat Datang, <?php echo e(Auth::user()->name); ?>!</h1>
    ...
    <div class="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 flex items-start space-x-3 text-amber-600 dark:text-amber-400 shadow-sm animate-pulse">
        ...
        <div class="flex-1">
            ...
            <p class="text-xs mt-0.5">Ada <strong><?php echo e($lowStockCount); ?></strong> barang yang telah mencapai atau berada di bawah batas minimum stok. Segera lakukan restok barang.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/50 rounded-3xl p-6 shadow-sm flex items-center space-x-4 transition-transform hover:scale-[1.01]">
            ...
            <div>
                ...
                <h3 class="text-xl font-extrabold tracking-tight mt-0.5 heading-font">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h3>
            </div>
        </div>
        ...
        <div class="bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/50 rounded-3xl p-6 shadow-sm flex items-center space-x-4 transition-transform hover:scale-[1.01]">
            ...
            <div>
                ...
                <h3 class="text-xl font-extrabold tracking-tight mt-0.5 heading-font"><?php echo e($totalTransactions); ?> Transaksi</h3>
            </div>
        </div>
        ...
        <div class="bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/50 rounded-3xl p-6 shadow-sm flex items-center space-x-4 transition-transform hover:scale-[1.01]">
            ...
            <div>
                ...
                <h3 class="text-xl font-extrabold tracking-tight mt-0.5 heading-font"><?php echo e($totalProducts); ?> Produk</h3>
            </div>
        </div>
        ...
        <div class="bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/50 rounded-3xl p-6 shadow-sm flex items-center space-x-4 transition-transform hover:scale-[1.01]">
            ...
            <div>
                ...
                <h3 class="text-xl font-extrabold tracking-tight mt-0.5 heading-font <?php echo e($lowStockCount > 0 ? 'text-rose-500' : ''); ?>"><?php echo e($lowStockCount); ?> Item</h3>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/50 rounded-3xl p-6 shadow-sm">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('transactions.index')); ?>" class="text-xs font-semibold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 underline heading-font">Lihat Semua</a>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse text-xs">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800/60">
                        ...
                        <tr>
                            <td class="py-3.5 font-bold text-indigo-600 dark:text-indigo-400"><?php echo e($transaction->invoice_number); ?></td>
                            <td class="py-3.5 font-medium"><?php echo e($transaction->user->name); ?></td>
                            <td class="py-3.5 text-slate-500 dark:text-slate-400"><?php echo e($transaction->buyer_name); ?></td>
                            <td class="py-3.5 font-bold">Rp <?php echo e(number_format($transaction->total_price, 0, ',', '.')); ?></td>
                            <td class="py-3.5 text-slate-500 dark:text-slate-400"><?php echo e($transaction->created_at->format('d/m H:i')); ?></td>
                            <td class="py-3.5 text-right">
                                <a href="<?php echo e(route('transactions.receipt', $transaction->id)); ?>" target="_blank" class="px-2.5 py-1 bg-indigo-500/10 text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-400 hover:bg-indigo-500 hover:text-white rounded-lg transition-colors inline-block">
        ...
        <div class="bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/50 rounded-3xl p-6 shadow-sm flex flex-col">
            ...
            <div class="flex-1 space-y-4">
                ...
                <div class="flex items-start space-x-3 text-xs">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 <?php echo e($act['type'] === 'in' ? 'bg-green-500/10 text-green-600 dark:bg-green-500/20 dark:text-green-400' : 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/20 dark:text-rose-400'); ?>">
                        <i class="fa-solid <?php echo e($act['type'] === 'in' ? 'fa-arrow-trend-up' : 'fa-arrow-trend-down'); ?>"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-baseline">
                            <h5 class="font-bold truncate"><?php echo e($act['title']); ?></h5>
                            <span class="text-[9px] text-slate-400 shrink-0"><?php echo e($act['time']); ?></span>
                        </div>
                        <p class="text-slate-500 dark:text-slate-400 truncate mt-0.5"><?php echo e($act['desc']); ?></p>
                        <span class="text-[9px] font-semibold text-slate-400 dark:text-slate-500">Pencatat: <?php echo e($act['user']); ?></span>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800/60">
                    ...
                    <tr>
                        <td class="py-3.5 flex items-center space-x-2.5">
                            <img src="<?php echo e($prod->image_url); ?>" alt="Barang" class="w-8 h-8 rounded-lg object-cover bg-slate-100 border dark:border-slate-800">
                            <span class="font-semibold"><?php echo e($prod->name); ?></span>
                        </td>
                        <td class="py-3.5 text-slate-500 dark:text-slate-400"><?php echo e($prod->category->name); ?></td>
                        <td class="py-3.5 font-mono"><?php echo e($prod->sku); ?></td>
                        <td class="py-3.5 text-center font-medium"><?php echo e($prod->min_stock); ?> pcs</td>
                        <td class="py-3.5 text-center">
                            <span class="px-2 py-0.5 bg-rose-500/10 text-rose-500 rounded-full font-bold">
                                <?php echo e($prod->stock); ?> pcs
                            </span>
                        </td>
                        <td class="py-3.5 text-right">
                            <a href="<?php echo e(route('stock.index')); ?>" class="px-3 py-1.5 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors shadow-sm shadow-green-500/10">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const catOptions = {
            ...
            series: <?php echo json_encode($categoryProductCounts); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\syarat kp\project kp\resources\views/dashboard/index.blade.php ENDPATH**/ ?>