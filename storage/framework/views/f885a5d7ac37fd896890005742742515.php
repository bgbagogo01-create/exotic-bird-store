...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - <?php echo e(\App\Models\Setting::get('shop_name', 'EXOTIC BIRD STORE')); ?></title>
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border-r border-slate-200/50 dark:border-slate-800/50 transform -translate-x-full md:translate-x-0 md:static transition-transform duration-300 ease-in-out flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto px-4 py-6 space-y-7">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('dashboard') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                        <i class="fa-solid fa-chart-line w-5 text-center group-hover:scale-110 transition-transform"></i>
                        <span>Dashboard</span>
                    </a>
                    
                    <a href="<?php echo e(route('catalog.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('catalog.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('categories.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                        <i class="fa-solid fa-tags w-5 text-center group-hover:scale-110 transition-transform"></i>
                        <span>Kategori Barang</span>
                    </a>
                    <?php endif; ?>

                    <a href="<?php echo e(route('products.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('products.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                        <i class="fa-solid fa-cubes w-5 text-center group-hover:scale-110 transition-transform"></i>
                        <span>Daftar Barang</span>
                    </a>

                    <a href="<?php echo e(route('stock.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('stock.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('transactions.pos')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('transactions.pos') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                    ...
                    <a href="<?php echo e(route('transactions.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('transactions.index') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('reports.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('users.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('users.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
                        <i class="fa-solid fa-users-gear w-5 text-center group-hover:scale-110 transition-transform"></i>
                        <span>Kelola Pengguna</span>
                    </a>

                    <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 group <?php echo e(Route::is('settings.*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/60 hover:text-slate-900 dark:hover:text-slate-100'); ?>">
            ...
            <div class="p-4 border-t border-slate-200/50 dark:border-slate-800/50">
                <div class="flex items-center space-x-3 px-2 py-1.5 bg-slate-50 dark:bg-slate-800/40 rounded-xl">
                    <img src="<?php echo e(Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&background=6366f1&color=fff'); ?>" alt="Avatar" class="w-9 h-9 rounded-lg object-cover ring-2 ring-indigo-500/20">
                    <div class="flex-1 overflow-hidden">
                        <h4 class="text-xs font-semibold truncate"><?php echo e(Auth::user()->name); ?></h4>
                        <span class="text-[9px] uppercase tracking-wider font-semibold text-indigo-600 dark:text-indigo-400"><?php echo e(Auth::user()->role ? Auth::user()->role->display_name : 'Staff'); ?></span>
                    </div>
                    <a href="<?php echo e(route('profile')); ?>" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200" title="Ubah Profil">
            ...
            <header class="h-16 flex items-center justify-between px-6 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50 z-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden sm:flex items-center space-x-2 text-xs text-slate-500 dark:text-slate-400">
                        ...
                        <span class="font-semibold text-slate-800 dark:text-slate-100 heading-font"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></span>
                    </div>
                </div>
    ...
    <script>
        ...
        <?php if(session('toast_error')): ?>
            Swal.fire({
                icon: 'error',
                title: 'Gagal!',
                text: "<?php echo e(session('toast_error')); ?>",
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
                timer: 4000,
        ...
        <?php if(session('toast_warning')): ?>
            Swal.fire({
                icon: 'warning',
                title: 'Peringatan!',
                text: "<?php echo e(session('toast_warning')); ?>",
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
                timer: 4500,
        ...
        <?php if($errors->any()): ?>
            Swal.fire({
                ...
                html: '<ul class="text-left text-xs list-disc pl-4"><?php echo implode("", $errors->all("<li>:message</li>")); ?></ul>',
...
<?php /**PATH D:\syarat kp\project kp\resources\views/layouts/app.blade.php ENDPATH**/ ?>